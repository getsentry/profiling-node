...
const cases = [
  ...
  ['/Users/jonas/code/src/file.js', 'src:file'],

  //   Preserves non .js extensions
  ['/Users/jonas/code/src/file.ts', 'src:file.ts'],
  //   No extension
  ['/Users/jonas/code/src/file', 'src:file'],
...
describe('GetFrameModule', () => {
  it.each(
    platform() === 'win32'
      ...
      : cases
  )('%s with base at %s = %s', (abs_path: string, expected: string) => {
