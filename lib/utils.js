...
exports.maybeRemoveProfileFromSdkMetadata = exports.isProfiledTransactionEvent = exports.createProfilingEventEnvelope = void 0;
...
function createProfilingEventEnvelope(event, dsn, metadata, tunnel) {
    ...
    if (!rawProfile) {
        throw new TypeError(`Cannot construct profiling event envelope without a valid profile. Got ${JSON.stringify(rawProfile).slice(0, 50)}`);
    }
    ...
    const profile = {
        ...
        transaction_name: (_b = event.transaction) !== null && _b !== void 0 ? _b : 'unknown transaction',
        duration_ns: `${rawProfile.duration_ns}`,
        environment: '',
        version_code: (_c = sdkInfo === null || sdkInfo === void 0 ? void 0 : sdkInfo.version) !== null && _c !== void 0 ? _c : 'unknown version',
        version_name: (_d = sdkInfo === null || sdkInfo === void 0 ? void 0 : sdkInfo.name) !== null && _d !== void 0 ? _d : 'unknown name',
        trace_id: (_f = (_e = envelopeHeaders.trace) === null || _e === void 0 ? void 0 : _e.trace_id) !== null && _f !== void 0 ? _f : 'unknown trace id',
